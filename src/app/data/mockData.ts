...
export const mockDebates: Debate[] = [
  {
    ...
    contributions: [
      ...
      },
      {
        ...
        aiTranscript: 'Bones notícies! Seguint els consells d\'en Carlos he instal·lat el smart meter al meu quadre elèctric. La instal·lació va ser més senzilla del que pensava, tot i que al principi em vaig confondre amb quin era el cable de la fase principal. El smart meter ja es veu a l\'app i detecta perfectament quan el meu inversor de Huawei injecta a la xarxa. Ara estic esperant que arribi la bateria per fer la prova completa. Si tot va bé faré un petit vídeo demostratiu per als socis que vulguin fer-ho ells mateixos. Crec que amb un bon tutorial en vídeo en català i en castellà, molta gent del grup local podria fer-ho sense problemes.',
        tags: ['evidence'],
        replyCount: 2,
  ...
  },
  {
    ...
    contributions: [
      ...
      },
      {
        ...
        aiTranscript: 'He mirat la meva factura dels últims sis mesos i la veritat és que és molt difícil entendre per quina raó alguns mesos la indexada surt millor i d\'altres pitjor. Hi ha moltes variables: el preu del mercat diari, els peatges, els càrrecs... Crec que necessitem comunicacions molt més clares, potser un butlletí mensual explicant com ha anat el mercat i per quin motiu la nostra tarifa ha resultat com ha resultat.',
        tags: ['argument'],
        replyCount: 2,
  ...
  },
  {
    ...
    contributions: [
      ...
      },
      {
        ...
        aiTranscript: 'El gran repte que veig és com fem que les CEL siguin realment inclusives. Si els veïns han de fer una aportació inicial per participar-ne, automàticament estem excloent les famílies amb menys recursos, que paradoxalment són les que més se\'n beneficiarien. Cal pensar en mecanismes de participació sense aportació inicial, o amb aportació mínima, com ara quotes socials reduïdes o fins i tot participació gratuïta per a famílies en risc de pobresa energètica.',
        tags: ['argument'],
        replyCount: 3,
